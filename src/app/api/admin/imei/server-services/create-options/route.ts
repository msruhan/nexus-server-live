...
import { fetchServerSupplierCatalog } from '@/lib/supplier-sync/fetch-catalog'
...
export async function GET(req: Request) {
  ...
  try {
    ...
    if (refresh) {
      const fetched = await fetchServerSupplierCatalog(api)
      return apiSuccess({
        providers,
    ...
    console.error('[ADMIN_SERVER_CREATE_OPTIONS_GET]', e)
